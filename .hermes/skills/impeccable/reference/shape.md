...
This is a required interaction, not optional guidance. Ask these questions in conversation, adapting based on answers. Don't dump them all at once; have a natural dialogue. ask the user directly to clarify.
...
ask the user directly to clarify. Ask for explicit confirmation of the brief before finishing.
